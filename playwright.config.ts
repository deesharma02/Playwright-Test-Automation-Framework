...
export default defineConfig({
  ...
  /* Run tests in parallel on CI. Override with PLAYWRIGHT_WORKERS when needed. */
  ...
  use: {
    ...
    /* Capture trace data for failed tests. See https://playwright.dev/docs/trace-viewer */
